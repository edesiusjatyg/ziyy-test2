...
export default function Page() {
  ...
  const loadTransactions = async () => {
    try {
      ...
      const weeklyTxs = data.filter((tx: Transaction) => {
      ...
      <div className={`w-full max-w-6xl py-8 px-4 transition-all duration-500 ${show ? "opacity-100" : "opacity-0"}`}>
        <div className="bg-white/60 backdrop-blur-xl rounded-2xl shadow-lg" style={{ boxShadow: '0 4px 24px 0 rgba(31, 38, 135, 0.08)' }}>
          <div className="flex items-center rounded-t-2xl px-8 py-4 mb-8" style={{ background: '#7bb3d6' }}>
            <div className="w-40 flex items-center gap-2 cursor-pointer" onClick={() => router.push("/acc")}>
            ...
            <div className="w-40 flex justify-end">
              <Breadcrumb>
                <BreadcrumbList>
                  <BreadcrumbItem>
                    <BreadcrumbLink href="/acc" className="text-white/80 hover:text-white transition-all text-sm md:text-base">
                      Accounting
                    </BreadcrumbLink>
                    <BreadcrumbSeparator></BreadcrumbSeparator>
                    <BreadcrumbPage className="text-white text-sm md:text-base">Transaksi Mingguan</BreadcrumbPage>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
